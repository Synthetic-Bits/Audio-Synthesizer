...
#define CHANNEL1_GPIO_PIN GPIO_PIN_6 // PC6
#define CHANNEL2_GPIO_PIN GPIO_PIN_7 // PC7
#define CHANNEL3_GPIO_PIN GPIO_PIN_8 // PC8
#define CHANNEL4_GPIO_PIN GPIO_PIN_9 // PC9
